    ...
    return (
        <div className="navbar lg:p-12">
            <div className="flex-1">
                <Link to='/' className="font-semibold text-xl lg:text-4xl text-black-600">Mariful Islam</Link>
            </div>
            <div className="flex-none">
            <label className="swap swap-rotate mr-4 btn btn-sm btn-secondary text-white btn-circle p-6 lg:p-6 ">
                <input type="checkbox" />
                ...
                <ul tabIndex={1} className="menu menu-compact dropdown-content mt-3 p-2 shadow rounded-box w-96 bg-white">
                    <li><Link to='/' className='hover:bg-common hover:text-white'><span>Home</span></Link></li>

        ...
        <section className='px-14 pt-10'>
            ...
            <div className="grid grid-cols-2 gap-x-10">
                <div className="lg:col-span-1 col-span-2">
                    ...
                    <h1 className='text-2xl font-semibold'>Resale Cars</h1>
                    </a>
                </div>
                <div className="lg:col-span-1 col-span-2">
                    ...
                    <h4 className='text-gray-500 mt-3 mb-1'>Front end Project</h4>
                    <h1 className='text-2xl font-semibold'>Jannet Dekker</h1>
                    </a>
                </div>
                <div className="lg:col-span-1 col-span-2">
                    ...
                    <h1 className='text-2xl font-semibold'>Web School</h1>
                    </a>
                </div>
                <div className="lg:col-span-1 col-span-2">
                    ...
                    <h4 className='text-gray-500 mt-3 mb-1'>React Project</h4>
                    <h1 className='text-2xl font-semibold'>Wen Quiz</h1>
                    </a>
                </div>
                <div className="lg:col-span-1 col-span-2">
                    ...
                    <h1 className='text-2xl font-semibold'>Pro Designer</h1>
                    </a>
                </div>
                <div className="lg:col-span-1 col-span-2">
                    ...
                    <h4 className='text-gray-500 mt-3 mb-1'>Web Design</h4>
                    <h1 className='text-2xl font-semibold'>Fitness Power</h1>
                    </a>
                </div>
            </div>
        </section>

...
const Contact = () => {
    return (
        ...
        <section className='lg:px-14 px-4 lg:pt-10 mt-5'>
        <div className="grid grid-cols-2 lg:gap-10 gap-1">
        ...
        <div className="card">
            <h2 className='lg:text-2xl text-1xl'>I'm always open to discussing product</h2>
            <h2 className='lg:text-2xl text-xl font-semibold mt-1 lg:mb-8 mb-3'>design work or partnerships.</h2>
            <form action="w-full">
            ...
            <div className="form-control w-full">
            <label className="label">
                <span className="label-text font-semibold lg:text-xl">Message *</span>
            </label>
            <textarea className="textarea textarea-secondary" required></textarea>
            </div>
            <button className="btn btn-outline btn-secondary lg:mt-8 mt-5 px-9">Submit</button>
            </form>
        </div>
        </section>
        <section>
